...
public class ProfileCompany extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_view_info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ProfileCompany.this, "Xem thông tin ", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void updateFollowButtonUI(boolean followed) {
        if(followed) {
            btn_follow.setBackground(ContextCompat.getDrawable(ProfileCompany.this, R.drawable.bovien_button_viencam));
            btn_follow.setTextColor(ContextCompat.getColor(ProfileCompany.this, R.color.orange));
            btn_follow.setText("Unfollow");
        } else {
            btn_follow.setBackground(ContextCompat.getDrawable(ProfileCompany.this, R.drawable.bovien_button_cam));
            btn_follow.setTextColor(ContextCompat.getColor(ProfileCompany.this, R.color.white));
    ...
    private void clickItemTot(PostViewHolder holder){
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                Intent intent = new Intent(ProfileCompany.this, DetailPost.class);
